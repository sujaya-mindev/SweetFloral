...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['first_name'], $_POST['last_name'], $_POST['phone'], $_POST['address'], $_POST['birthday'])) {
        ...
        $update_query = "UPDATE customer SET first_name = ?, last_name = ?, phone_no = ?, address = ?, birthday = ? WHERE email = ?";
        $update_stmt = $conn->prepare($update_query);
        $update_stmt->bind_param("ssssss", $first_name, $last_name, $phone, $address, $birthday, $user_email);
    ...
    if (isset($_POST['current_password'], $_POST['new_password'], $_POST['confirm_password'])) {
        ...
        if (password_verify($current_password, $user['password'])) {
            ...
            if ($new_password == $confirm_password) {
                ...
                $update_password_query = "UPDATE customer SET password = ? WHERE email = ?";
                ...
                <form method="POST">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo htmlspecialchars($user['phone_no']); ?>" required>
                        </div>
                        <div class="col-md-12">
